...
[RegisterPower]
public class RedQueenDiceTemporaryDexterityPower : ModPowerTemplate, ITemporaryPower
{
    ...
    public override async Task AfterPowerAmountChanged(PowerModel power, decimal amount, Creature? applier, CardModel? cardSource)
    {
        if (power == this)
        {
            ...
            await PowerCmd.Apply<DexterityPower>(Owner, amount, applier, cardSource, silent: true);
        }
    }
