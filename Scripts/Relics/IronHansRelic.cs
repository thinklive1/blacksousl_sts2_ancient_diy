...
/// <summary>Implements the Iron Hans relic.</summary>
[RegisterRelic(typeof(EventRelicPool))]
public sealed class IronHansRelic : ModRelicTemplate
{
    ...
    protected override IEnumerable<IHoverTip> AdditionalHoverTips =>
        HoverTipFactory.FromEnchantment<ArmamentEnchantment>();
    ...
    public override async Task AfterObtained()
    {
        foreach (CardModel card in await CardSelectCmd.FromDeckForEnchantment(
            ...
            player: Owner,
            enchantment: ModelDb.Enchantment<ArmamentEnchantment>(),
            amount: DynamicVars.Cards.IntValue))
        {
            CardCmd.Enchant<ArmamentEnchantment>(card, 1m);
