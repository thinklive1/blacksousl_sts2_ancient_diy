...
public sealed class RedQueenGuillotineRelic : ModRelicTemplate
{
    ...
    protected override IEnumerable<IHoverTip> AdditionalHoverTips =>
        HoverTipFactory.FromCardWithCardHoverTips<RedQueenGuillotineCard>();

    public override RelicAssetProfile AssetProfile => new(
        IconPath: "res://bs_ancient/assets/images/relics/RedQueenGuillotineRelic.png",
        IconOutlinePath: "res://bs_ancient/assets/images/relics/RedQueenGuillotineRelic.png",
        BigIconPath: "res://bs_ancient/assets/images/relics/RedQueenGuillotineRelic.png"
    );
