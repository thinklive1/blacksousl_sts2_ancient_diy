...
/// <summary>Implements the Red Queen Soldier relic.</summary>
...
public class RedQueenSoldierRelic : ModRelicTemplate
{
    ...
    protected override IEnumerable<IHoverTip> AdditionalHoverTips => [
        ...
        new HoverTip(
            new LocString("relics", "BS_ANCIENT_RELIC_RED_QUEEN_PROMOTION_RELIC.title"),
            new LocString("relics", "BS_ANCIENT_RELIC_RED_QUEEN_PROMOTION_RELIC.description"))
    ];
