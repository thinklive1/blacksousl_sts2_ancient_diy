...
- Jabberwock's Film Reel: gain Jabberwock at the start of combat. Jabberwock's attacks heal HP equal to unblocked damage dealt. It cannot gain Block, and playing a non-Attack card deals damage equal to 20% of your Max HP.
...
- Fairy Tale - Jack and the Beanstalk: after each node, lose 5 HP, down to a minimum of 1. On the 6th node, gain Max HP equal to the total lost, then this relic becomes inactive.
...
- Girl's Hand Mirror: on pickup, gain Liddell's Reflection. The first time you take damage in combat, reflect that much damage to the source. Liddell's Reflection is an unplayable Curse; when exhausted or when it vanishes due to Ethereal, it copies your entire deck, gives the copies Ethereal, and adds them to the discard pile.
